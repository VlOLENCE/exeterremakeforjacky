...
stream_url = "https://www.twitch.tv/xqcow"
tts_language = "en"
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(name="OG 5LO" + str(Exeter.command_prefix),
                         icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(url="https://media.discordapp.net/attachments/821519855639068692/821569672347910154/image0.gif?width=406&height=406")
